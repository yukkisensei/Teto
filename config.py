...
SOUNDCLOUD_API_BASE = os.getenv("SOUNDCLOUD_API_BASE", "https://api.soundcloud.com").strip()
SOUNDCLOUD_OAUTH_URL = os.getenv("SOUNDCLOUD_OAUTH_URL", "https://secure.soundcloud.com/oauth/token").strip()
...
# Rate limits / anti-spam defaults
ANTI_SPAM_ENABLED = os.getenv("ANTI_SPAM_ENABLED", "1") == "1"
ANTI_SPAM_RATE = int(os.getenv("ANTI_SPAM_RATE", "6"))  # messages
ANTI_SPAM_INTERVAL = int(os.getenv("ANTI_SPAM_INTERVAL", "8"))  # seconds
MAX_MENTIONS = int(os.getenv("MAX_MENTIONS", "5"))

ANTI_RAID_ENABLED = os.getenv("ANTI_RAID_ENABLED", "1") == "1"
ANTI_RAID_THRESHOLD = int(os.getenv("ANTI_RAID_THRESHOLD", "6"))  # joins
ANTI_RAID_WINDOW = int(os.getenv("ANTI_RAID_WINDOW", "10"))  # seconds
...
# Bot ratio guard (avoid bot > people)
